...
ph = figure(toolbar_location=None,plot_height=200, # plot_width=p.plot_width,  #x_range=p.x_range,
...
layout = column(row(ph))#, row(ph, Spacer(width=200, height=200)))
...
hh1.data_source.on_change('selected', update)
